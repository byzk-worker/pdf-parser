...
function requireBrowser () {
	if (hasRequiredBrowser) return browser$5.exports;
...
if (process.env.NODE_ENV !== 'production') {
  debug$i = requireBrowser()('sockjs-client:utils:url');
}
...
inherits$t(EventEmitter$e, EventTarget$1);

EventEmitter$e.prototype.removeAllListeners = function(type) {
  if (type) {
...
EventEmitter$e.prototype.once = function(type, listener) {
  var self = this
    , fired = false;
...
EventEmitter$e.prototype.emit = function() {
...
EventEmitter$e.prototype.on = EventEmitter$e.prototype.addListener = EventTarget$1.prototype.addEventListener;
EventEmitter$e.prototype.removeListener = EventTarget$1.prototype.removeEventListener;

emitter.EventEmitter = EventEmitter$e;
...
var utils$3 = event$1.exports
  , urlUtils$a = url
  , inherits$s = inherits_browser.exports
  , EventEmitter$d = emitter.EventEmitter
  , WebsocketDriver = websocket$1.exports
  ;

var debug$h = function() {};
if (process.env.NODE_ENV !== 'production') {
  debug$h = requireBrowser()('sockjs-client:websocket');
}
...
function WebSocketTransport(transUrl, ignore, options) {
  ...
  this.ws.onclose = function(e) {
    debug$h('close event', e.code, e.reason);
    self.emit('close', e.code, e.reason);
    self._cleanup();
  };
  this.ws.onerror = function(e) {
    debug$h('error event', e);
    self.emit('close', 1006, 'WebSocket connection broken');
    self._cleanup();
  };
}

inherits$s(WebSocketTransport, EventEmitter$d);
...
var inherits$r = inherits_browser.exports
  , EventEmitter$c = emitter.EventEmitter
  ;

var debug$g = function() {};
if (process.env.NODE_ENV !== 'production') {
  debug$g = requireBrowser()('sockjs-client:buffered-sender');
}
...
inherits$r(BufferedSender$1, EventEmitter$c);
...
var inherits$q = inherits_browser.exports
  , EventEmitter$b = emitter.EventEmitter
  ;

var debug$f = function() {};
if (process.env.NODE_ENV !== 'production') {
  debug$f = requireBrowser()('sockjs-client:polling');
}
...
inherits$q(Polling$1, EventEmitter$b);
...
Polling$1.prototype._scheduleReceiver = function() {
  ...
  poll.once('close', function(code, reason) {
    debug$f('close', code, reason, self.pollIsClosing);
    self.poll = poll = null;
...
if (process.env.NODE_ENV !== 'production') {
  debug$e = requireBrowser()('sockjs-client:sender-receiver');
}
...
inherits$p(SenderReceiver$2, BufferedSender);
...
if (process.env.NODE_ENV !== 'production') {
  debug$d = requireBrowser()('sockjs-client:ajax-based');
}

function createAjaxSender(AjaxObject) {
  return function(url, payload, callback) {
    debug$d('create ajax sender', url, payload);
    var opt = {};
...
inherits$o(AjaxBasedTransport$6, SenderReceiver$1);

var ajaxBased = AjaxBasedTransport$6;

var inherits$n = inherits_browser.exports
  , EventEmitter$a = emitter.EventEmitter
  ;

var debug$c = function() {};
if (process.env.NODE_ENV !== 'production') {
  debug$c = requireBrowser()('sockjs-client:receiver:xhr');
}
...
inherits$n(XhrReceiver$4, EventEmitter$a);
...
var EventEmitter$9 = emitter.EventEmitter
  , inherits$m = inherits_browser.exports
  , utils$2 = event$1.exports
  , urlUtils$7 = url
...
if (process.env.NODE_ENV !== 'production') {
  debug$b = requireBrowser()('sockjs-client:browser:xhr');
}
...
inherits$m(AbstractXHRObject, EventEmitter$9);
...
inherits$l(XHRCorsObject$3, XhrDriver$1);
...
var inherits$k = inherits_browser.exports
  , XhrDriver = abstractXhr
  ;

function XHRLocalObject$3(method, url, payload /*, opts */) {
  XhrDriver.call(this, method, url, payload, {
    noCredentials: true
  });
}

inherits$k(XHRLocalObject$3, XhrDriver);

XHRLocalObject$3.enabled = XhrDriver.enabled;

var xhrLocal = XHRLocalObject$3;
...
function XhrStreamingTransport(transUrl) {
  if (!XHRLocalObject$2.enabled && !XHRCorsObject$2.enabled) {
    throw new Error('Transport created when disabled');
  }
  AjaxBasedTransport$5.call(this, transUrl, '/xhr_streaming', XhrReceiver$3, XHRCorsObject$2);
}

inherits$j(XhrStreamingTransport, AjaxBasedTransport$5);
...
var EventEmitter$8 = emitter.EventEmitter
  , inherits$i = inherits_browser.exports
  , eventUtils$2 = event$1.exports
  , browser$2 = browser$4
  , urlUtils$6 = url
  ;
...
if (process.env.NODE_ENV !== 'production') {
  debug$a = requireBrowser()('sockjs-client:sender:xdr');
}
...
inherits$i(XDRObject$2, EventEmitter$8);
...
XDRObject$2.prototype._start = function(method, url, payload) {
  ...
  url = urlUtils$6.addQuery(url, 't=' + (+new Date()));
  ...
  xdr.onprogress = function() {
    debug$a('progress', xdr.responseText);
...
inherits$h(XdrStreamingTransport$1, AjaxBasedTransport$4);
...
var inherits$g = inherits_browser.exports
  , EventEmitter$7 = emitter.EventEmitter
  , EventSourceDriver$1 = eventsource$2
  ;

var debug$9 = function() {};
if (process.env.NODE_ENV !== 'production') {
  debug$9 = requireBrowser()('sockjs-client:receiver:eventsource');
}
...
inherits$g(EventSourceReceiver$1, EventEmitter$7);
...
inherits$f(EventSourceTransport, AjaxBasedTransport$3);
...
function requireIframe () {
	if (hasRequiredIframe) return iframe$1.exports;
	hasRequiredIframe = 1;
	(function (module) {

		var eventUtils = event$1.exports
		  , browser = browser$4
		  ;

		var debug = function() {};
		if (process.env.NODE_ENV !== 'production') {
		  debug = requireBrowser()('sockjs-client:utils:iframe');
		}
...
var inherits$e = inherits_browser.exports
  , EventEmitter$6 = emitter.EventEmitter
  , version = requireVersion()
  , urlUtils$5 = url
  , iframeUtils$1 = requireIframe()
  , eventUtils$1 = event$1.exports
  , random$4 = random$5
  ;

var debug$8 = function() {};
if (process.env.NODE_ENV !== 'production') {
  debug$8 = requireBrowser()('sockjs-client:transport:iframe');
}
...
function IframeTransport$2(transport, transUrl, baseUrl) {
  ...
  debug$8(transport, transUrl, iframeUrl);

  this.iframeObj = iframeUtils$1.createIframe(iframeUrl, function(r) {
...
inherits$e(IframeTransport$2, EventEmitter$6);
...
IframeTransport$2.prototype._message = function(e) {
  debug$8('message', e.data);
  if (!urlUtils$5.isOriginEqual(e.origin, this.origin)) {
    debug$8('not same origin', e.origin, this.origin);
    return;
  }
...
var iframeWrap = function(transport) {
  ...
  inherits$d(IframeWrapTransport, IframeTransport$1);
...
var inherits$c = inherits_browser.exports
  , iframeUtils = requireIframe()
  , urlUtils$4 = url
  , EventEmitter$5 = emitter.EventEmitter
  , random$3 = random$5
  ;

var debug$7 = function() {};
if (process.env.NODE_ENV !== 'production') {
  debug$7 = requireBrowser()('sockjs-client:receiver:htmlfile');
}
...
function HtmlfileReceiver$1(url) {
  ...
  url = urlUtils$4.addQuery(url, 'c=' + decodeURIComponent(iframeUtils.WPrefix + '.' + this.id));
...
inherits$c(HtmlfileReceiver$1, EventEmitter$5);
...
function HtmlFileTransport(transUrl) {
  ...
  AjaxBasedTransport$2.call(this, transUrl, '/htmlfile', HtmlfileReceiver, XHRLocalObject$1);
}

inherits$b(HtmlFileTransport, AjaxBasedTransport$2);
...
inherits$a(XhrPollingTransport, AjaxBasedTransport$1);
...
inherits$9(XdrPollingTransport, AjaxBasedTransport);
...
var utils$1 = requireIframe()
  , random$2 = random$5
  , browser$1 = browser$4
  , urlUtils$3 = url
  , inherits$8 = inherits_browser.exports
  , EventEmitter$4 = emitter.EventEmitter
  ;

var debug$6 = function() {};
if (process.env.NODE_ENV !== 'production') {
  debug$6 = requireBrowser()('sockjs-client:receiver:jsonp');
}
...
function JsonpReceiver$1(url) {
  ...
  var urlWithId = urlUtils$3.addQuery(url, 'c=' + encodeURIComponent(utils$1.WPrefix + '.' + this.id));
...
inherits$8(JsonpReceiver$1, EventEmitter$4);
...
if (process.env.NODE_ENV !== 'production') {
  debug$5 = requireBrowser()('sockjs-client:sender:jsonp');
}
...
var jsonp = function(url, payload, callback) {
  ...
  form.target = id;
  form.action = urlUtils$2.addQuery(urlUtils$2.addPath(url, '/jsonp_send'), 'i=' + id);
  ...
  iframe.onreadystatechange = function(e) {
    debug$5('onreadystatechange', id, iframe.readyState, e);
...
inherits$7(JsonPTransport, SenderReceiver);
...
if (process.env.NODE_ENV !== 'production') {
  debug$4 = requireBrowser()('sockjs-client:utils:transport');
}
...
inherits$6(CloseEvent$1, Event$2);
...
inherits$4(XHRFake$1, EventEmitter$3);
...
var EventEmitter$2 = emitter.EventEmitter
  , inherits$3 = inherits_browser.exports
  , objectUtils$1 = object
  ;

var debug$3 = function() {};
if (process.env.NODE_ENV !== 'production') {
  debug$3 = requireBrowser()('sockjs-client:info-ajax');
}

function InfoAjax$1(url, AjaxObject) {
...
inherits$3(InfoAjax$1, EventEmitter$2);

InfoAjax$1.prototype.close = function() {
  this.removeAllListeners();
  this.xo.close();
};

var infoAjax = InfoAjax$1;
...
var EventEmitter$1 = emitter.EventEmitter
  , inherits$2 = inherits_browser.exports
  , utils = event$1.exports
...
if (process.env.NODE_ENV !== 'production') {
  debug$2 = requireBrowser()('sockjs-client:info-iframe');
}
...
var EventEmitter = emitter.EventEmitter
  , inherits$1 = inherits_browser.exports
  , urlUtils$1 = url
  , XDR = xdr
  , XHRCors = xhrCors
  , XHRLocal = xhrLocal
...
if (process.env.NODE_ENV !== 'production') {
  debug$1 = requireBrowser()('sockjs-client:info-receiver');
}
...
InfoReceiver$1.prototype.doXhr = function(baseUrl, urlInfo) {
  var self = this
    , url = urlUtils$1.addPath(baseUrl, '/info')
    ;
  debug$1('doXhr', url);
...
function requireIframeBootstrap () {
	...
	var debug = function() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = requireBrowser()('sockjs-client:iframe-bootstrap');
	}
...
var debug = function() {};
if (process.env.NODE_ENV !== 'production') {
  debug = requireBrowser()('sockjs-client:main');
}
...
function requireWebsocketClient () {
	...
	const sockjs_client_1 = __importDefault(entry);
	const types_1 = types;
	const socketContext_1 = requireSocketContext();
	const types_2 = types$1;
	const data_1 = requireData();
	const asyncLock_1 = __importDefault(asyncLock);
...
const httpReq = async (params, options) => {
...
const httpReqInRetry = async (params, options, nowRetryCount) => {
    try {
...
const socketBaseReq = async (params) => {
    try {
        var payload = {
            mod: "1",
            needReturn: true,
...
const socketReq = async (params, options) => {
    const opt = options ?? connectConfigGet();
    return new Promise(async (resolve, reject) => {
        if (opt.timeout && opt.timeout > 0) {
            setTimeout(() => {
...
const socketReqInRetry = async (params, options, nowRetryCount) => {
 ...
 * @returns
 */
const sealVerifyAll = async (fileId, options) => {
    let rst = await verifySeal(fileId, options);
    if (!arrayIsNull(rst)) {
        rst.forEach(element => {
 ...
 * @returns
 */
const sealQuery = async (password, options) => {
 ...
 * @returns 签章后的新的文件id
 */
const sealIn = async (params, options) => {
