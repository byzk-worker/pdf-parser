...
export function showSignSealTip(rootEle?: HTMLElement, signSealTime?: [],signSealInfo?:any) {
  ...
  var signSealEle = `<div id="${elementGuid}" class='${styles.maskContainer}'>
    <div class='${styles.mask}'>
          <div class='${styles.title}'> 签章信息 <span class='${ styles.close }' onclick="document.getElementById('${elementGuid}').remove()">
          <img width=100% title="关闭" src="data:image/png;base64," />
      </span></div>
      <div class='${styles.content}'>
        <div class='${styles.titleTip}'>
          ...
          <div class='${styles.titleTipRight}'>
            <div class='${styles.top}'>签章验证失败，签章无效。</div>
            <div class='${ styles.bottom }'>-签章验证失败（参考补充列表，也可以在此处显示代码验证信息说明）</div>
          </div>
        </div> 
        <hr />
        <div>
        ...
        <div >
            ...
            <div style=display:flex;flex-direction:row;>
                <div class='${styles.timeInfoLeft}'>
                    <div class='${ styles.leftInfo }'>该印章包含时间戳，时间戳已验证成功。</div>
                    <div class='${ styles.leftInfo }'>单击“详细信息”查看时间戳的颁发机构证书的详细信息。</div>
                </div>
                <div>
